          ...
          <div className="w-full md:w-[720px]">
            ...
            >
              <div className="flex flex-col w-full gap-5 md:flex-row">
                <input
                  type="text"
                  className="border border-gray-300 text-gray-900 text-[15px] block w-full rounded-md p-[15px] placeholder:text-gray-400"
              ...
              <textarea
                id="message"
                rows={7}
                className="block p-[15px] w-full text-sm text-gray-900 border rounded-md border-gray-300 placeholder:text-gray-400"
              ...
              <button
                type="submit"
                className="text-base font-medium text-white bg-gray-400 rounded-md px-7 md:px-12 py-[15px] hover:bg-gray-600 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-400"
        ...
        <div className="flex flex-col gap-10 items-start justify-center max-w-[300p x] md:w-full">
          ...
          <div className="flex gap-5 items-start justify-center">
            ...
            <div className="flex flex-col items-start justify-center gap-3">
              ...
              <p className="text-gray-500 leading-[16px]">
                +234-909-124-7724
              </p>
            </div>
          </div>
